        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel1">Triagem</h4>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-8 text-center">
                                                        ...
                                                        <button type="submit" name="excel" class="btn btn-warning" value="excel">Exportar </button>
                                                        ...
                                                        left join tipo_origem k on cast(k.tipo_id as varchar)=a.tipo ";
                                                            ...
                                                            while ($row = pg_fetch_object($sth)) {
                                                                ...
                                                                if ($row->coronavirus == 1) {
                                                                    ...
                                                                    echo "<td class='blink'>" . inverteData(substr($row->cadastro, 0, 10)) . ' ' . $row->hora_cad .  "</td>";
                                                                    echo "<td class='blink' onclick=\"window.open('novoatendimento.php?id=" . $row->transacao . "')\">" . $row->nome . "</td>";
                                                                    ...
                                                                    if ($row->status == 'Atendimento Finalizado') {
                                                                        ...
                                                                        echo "<small class='blink'>" . substr($row->nomemed, 0, 21) . "</small></td>";
                                                                    } else {
                                                                    ...
                                                                    echo "<td ><a data-toggle=\"popover\" data-content=\"Ir para o cadastro do paciente.\" data-trigger=\"hover\" data-original-title=\"Paciente\" href='novoatendimento.php?id=" . $row->transacao . "' target='_blank'>" . $row->nome . "</a></td>";
                                                                ...
                                                                echo "<a href=\"atendimentoclinico.php?id=$row->transacao\" target=\"_blank\" class=\"btn btn-sm btn-icon btn-pure btn-default delete-row-btn\" data-toggle=\"tooltip\" data-original-title=\"Visualizar\"><i class=\"icon wb-search\" aria-hidden=\"true\"></i></a>";
                                                                /*}*/


                                                                if ($row->tipo == 9) {
                                                                    echo "<a href=\"relOdonto.php?id=$row->transacao\" target=\"_blank\" class=\"btn btn-sm btn-icon btn-pure btn-default delete-row-btn\" data-toggle=\"tooltip\" data-original-title=\"ODONTOLOGICO\"><i class=\"icon wb-print\" aria-hidden=\"true\"></i></a>";
                                                                } else {
                                                                    echo "<a href=\"relFAA.php?id=$row->transacao\" target=\"_blank\" class=\"btn btn-sm btn-icon btn-pure btn-default delete-row-btn\" data-toggle=\"tooltip\" data-original-title=\"FAA\"><i class=\"icon wb-print\" aria-hidden=\"true\" ></i></a>";
                                                                }
                                                                // if ($perfil == '06' or $perfil == '04') { 
                                                            ?>
                                                                <?php if ($row->status != 'Atendimento Finalizado') { ?>
                                                                    <a id="triagemmanual" data-id="<?php echo $row->transacao; ?>" class="btn btn-sm btn-icon btn-pure btn-default delete-row-btn" data-target="#modalConteudo" data-toggle="modal" data-original-title="Triagem" onClick="valorTriagem(this);">
                                                                ...
                                                                if ($perfil == '06' or $perfil == '04' or $perfil == '01') { ?>
                                                                    <a id="mudasituacao" data-id="<?php echo $row->transacao; ?>" class="btn btn-sm btn-icon btn-pure btn-default delete-row-btn" data-target="#modalConteudoSitu" data-toggle="modal" data-original-title="Mudar Situação" onClick="valorSituacao(this);">
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <div class="col-md-12" id="conteudoModalSituacao"></div>
                                                                    <div class="col-md-12 margin-top-10 padding-0">
                                                                        <div class="col-md-6">
                                                                            <input type='button' name='confSit' id="confSit" class="btn btn-success width-full" value='Confirmar Situação'>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <input type='button' name='cancelarModal' data-dismiss="modal" id="cancelarModal" class="btn btn-danger width-full" value='Cancelar'>
                                                                        </div>

							...
							<div class="card-content">
										...
										<div class="panel">
											<div class="panel-body">
												...
												<div class="row">
													<div class="col-3">
														...
														<select class="form-control" name="procedimentox"
															id="procedimentox">
													...
													<div class="col-3">
														<label class="control-label"
															for="inputBasicFirstName">Prontuário</label>
														...
														<div class="row">
															<div class="col-1">
																<div class="checkbox-custom checkbox-primary">
																	<input type="checkbox" name="cb_rx" value='RX'
																		<?php if ($RX == 'RX') {
																echo 'checked';
															} ?>>
																	<label>RX</label>
															...
															<div class="col-1">
																<div class="checkbox-custom checkbox-primary">
																	<input type="checkbox" name="cb_us" value='US'
																		<?php if ($US == 'US') {
																echo 'checked';
															} ?>>
																	<label>US</label>
															...
															<div class="col-1">
																<div class="checkbox-custom checkbox-primary">
																	<input type="checkbox" name="cb_ec" value='EC'
																		<?php if ($EC == 'EC') {
																echo 'checked';
															} ?>>
																	<label>ECG</label>
											...
											<div class="col-12 mt-3" align="center">
												...
												<button type="submit" name="hoje" value="hoje"
													class="btn btn-success">Hoje</button>
											</div>
								...
								<div class="panel">
									...
									<div class="panel-body"><br><br>
										<table id="dados" class="table dataTable condensed width-full"
												...
												<tr>
													<th>
														<div class="checkbox-custom checkbox-primary"><input
																...
																onclick='marcardesmarcar();' value="T"><label></label>
														</div>
													</th>

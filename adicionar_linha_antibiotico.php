...
<script>
    $("#tb<?= $categoria; ?>_antibiotico tbody").append(
        ...
        "<td><select class='form-control selectnew multat' data-size='4' multiple='multiple' data-live-search='true' name='antibiotico[]' id='antibiotico' ><option value=''></option><?php
                                                                                                                                                                                        include('conexao.php');

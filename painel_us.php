...
<head>
    ...
    <title>FUNEPU | Painel Ultrassonografia</title>
            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-12">
                                    ...
                                    <div class="col-6">
                                        <div class="float-right">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="active">Painel Ultrassonografia</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                include('conexao.php');
                                                $stmt = "Select * from modalidades WHERE modalidade_id = 2";
						...
						WHERE f.modalidade_id = 2 AND b.dat_cad = '$data' AND a.situacao = 'Cadastrando'

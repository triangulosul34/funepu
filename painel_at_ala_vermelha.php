...
<body class="pace-done" cz-shortcut-listen="true">
    ...
    <div class="main-panel">
                                    ...
                                    <div class="col-6">
                                        <div class="float-right">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="active">Ala Vermelha</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
        ...
        <script>
            ...
            $(".expande-lote-i").click(function() {
                expandeLote($(this));
            });

            // Expande a linha do lote clicado
            function expandeLote(oLote) {

                var oLote = $(oLote);
                var oLinhaExpande = oLote.closest("tr");
                var oLinhaNova = $("#linha-expande-" + oLote.attr("id"));

                if (!oLinhaNova.length) {

                    $.post("buscaexames.php", {
                            lote_id: 1
                        }, function(data) {})
                        .done(function(data) {
                        ...
                        .fail(function() {
                            alert("Falha ao buscar o lote!");
                        });

                    $(".select-all-input").change(function() {

                        var oCheckBox = $(this);
                        var oCheckBoxAll = oCheckBox.closest("table").find(":checkbox");

                        if (oCheckBox.is(":checked")) {
                            oCheckBoxAll.prop("checked", true);
                        } else {
                            oCheckBoxAll.prop("checked", false);
                        }
                    });

                    $(".select-single-input").change(function() {
            ...
            function doConfirm(id) {
                ...
                if (ok) {
                    ...
                    xmlhttp.open("GET", "apagamodalidade.php?id=" + id);
                    xmlhttp.send();
                }
            }

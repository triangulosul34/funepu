...
$result = pg_query($sql) or die("Atestado invalido!!!");
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-12">
                                                <h4 class="card-title">
                                                    <p style="color: #12A1A6;display:inline;font-size: 8pt;font-weight: bold;">
                                                        » </p>Atestados
                                                </h4>
                                            </div>
                                            <div class="col-12">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <p>Paciente: <?php echo iniciais($rowa->nome); ?></p>
                                            <p>Data: <?php echo inverteData($rowa->partir_dia); ?></p>
                                            <p>Dias de Atestado: <?php echo $rowa->qtd_dias; ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>

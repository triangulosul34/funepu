                                                ...
                                                <div class="row m-0">
                                                    ...
                                                    <div class="col-lg-6 col-md-12 bg-white px-4 pt-3">
                                                        <form name='formulario' method='POST' action='checklogin.php'>
                                                            <h4 class="mb-3 card-title"><strong>Verificação de atestado</strong></h4>
                                                            <p><b>Paciente:</b> <?php echo $nome == '' ? '<span style="color:red">Não encontrado</span>' : iniciais($nome); ?></p>
                                                            <p><b>Data:</b> <?php echo $dia == '' ? '<span style="color:red">Não encontrado</span>' : inverteData($dia); ?></p>
                                                            <p><b>Dias de Atestado:</b> <?php echo $dia == '' ? '<span style="color:red">Não encontrado</span>' : $qtd; ?></p>
                                                            <div class="row">
                                                                <div class='col-md-6' align='center'>
                                                                    <?php if ($nome == '') { ?>
                                                                        <i class="fas fa-times-circle font-large-1" style="color: red;"></i>
                                                                    <?php } else { ?>
                                                                        <i class="fas fa-check-circle font-large-1" style="color: #15AABF;"></i>
                                                                    <?php } ?>
                                                                </div>

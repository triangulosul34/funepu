						...
						<div class="card">
							...
							<div class="card-content">
								<div class="card-body">
									...
									<div class="row mt-4">
										<div class="col-6">
											<h3 class="title" align="center" style="margin-bottom: -15px;">Exames
												Radiologicos</h3><br>
											<hr
												style="width: 100%; color: #FF0000; height: 1px; background-color: #FF0000;" />
											<br>
											<div class="scroll">
												<table class="table">
													<thead>
										...
										<div class="col-6">
											...
											<div class="row">
												<div class="col-md-12 text-center">
													...
													<input type='button' name='imprimir_exames' id="imprimir_exames"
														class="btn btn-primary" value='Imprimir Exames'
														onclick="laboratorio()">
												</div>
											</div>
										</div>

...
<head>
    ...
    <title>FUNEPU | Painel Odontologia</title>
        ...
        <div class="main-content">
                                    ...
                                    <div class="col-6">
                                        <div class="float-right">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="active">Painel Odontologia</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-content">
                                <div class="card-body">
									...
									left join tipo_origem k on k.tipo_id=cast(a.tipo as integer) ";
                                                    ...
                                                    $stmt = $stmt . " AND a.tipo = '9' order by 5 ";
            ...
            <script>
                function atualizar() {
                    ...
                    var url = 'atualizaatendimentos_odontologico.php?start=' + start + '&end=' + end + '&modalidade=' + modalidade + '&situacao=' + situacao + '&nome=' + nome;

...
// $sql = "SELECT a.transacao FROM atendimentos a 
// LEFT JOIN destino_paciente b ON a.transacao = b.atendimento_id
// WHERE (a.destino_paciente in ('07','10','03', '', '0') or a.destino_paciente is null) and (destino_encaminhamento = 3) and a.dat_cad < '2020-08-30' and a.transacao not in(358527,358115,358395,358119,358382,358826,357020,358240,358173,358198,357870,358067,358267,357933,357488)";
// $result = pg_query($sql) or die($sql);
// while ($row = pg_fetch_object($result)) {

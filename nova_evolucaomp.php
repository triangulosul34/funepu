...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($erro == '') {
		...
		$stmt = "insert into assistente_social  (atendimento_id,data,hora,usuario,relatorio)
						values ($transacao,'$datacad','$horacad','$usuario','$evolucao')";
		$sth = pg_query($stmt) or die($stmt);

		header('location: evolucao_atendimentomp.php?id=' . $transacao);
	}
}
?>
<!DOCTYPE html>
                                ...
                                <div class="card-body">
                                    <form method="post" id="pedido" name='pedido'>
                                        ...
                                        <div class="row mt-2  mb-2">
                                            <div class="col-12">
                                                <h3 align="center">Novo Relatorio</h3>
                                                <hr style="width: 100%" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <textarea name="evolucao" class="form-control square" rows="10"
                                                    cols="50" style="resize: none"></textarea> </br>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12" align="center">
                                                <input type='submit' name='gravar' class="btn btn-primary"
                                                    value='Gravar' onclick="return valida()">

                                                <a href="evolucao_atendimentomp.php?id=<?php echo $_GET['id'] ?>"

...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['gerarrelatorio'])) {
        ...
        $stmtRel = "SELECT count(*) as qtde, origem
				...
				where a.dat_cad between '$start' and '$end' 
				group by 2";
...
<head>
    ...
    <title>FUNEPU | Relatorio de Demanda</title>
...
<body class="pace-done" cz-shortcut-listen="true">
                                    ...
                                    <div class="col-6">
                                        <div class="float-right">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="active">Relatorio demanda</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $("#imprimirelatorio").click(function(event) {
            ...
            var url = 'relAtendimento.php?start=' + start + '&end=' + end + '&tipo_relatorio=demanda';
            window.open(url);
        });
    </script>
</body>

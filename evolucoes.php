                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                ...
                                                <input type="text" class="form-control square" id="inputBasicFirstName"
                                                    name="nome" placeholder="Parte do Nome" autocomplete="off" value="<?php
													$nome; ?>" onkeyup="maiuscula(this)" />
                                            </div>
                                            <div class="col-3">
							...
							left join tipo_origem k on k.tipo_id=cast(a.tipo as integer) ";
														...
														while ($row = pg_fetch_object($sth)) {
															...
															if ($row->coronavirus == 1) {
																...
																echo "<td class='blink' style='border-bottom:3px solid #eee;'>" . ts_decodifica($row->nome) . '</td>';
																...
																echo "<td style='border-bottom:3px solid #eee;'>" . ts_decodifica($row->nome) . '</td>';

                                        ...
                                        <div class="col-md-12 col-xs-12 masonry-item">
                                            <div class="widget">
                                                <div class="widget-header white bg-cyan-600 padding-30 clearfix">
                                                    <a class="avatar avatar-100 pull-left margin-right-20" href="javascript:void(0)"> <img src="<?php if ($imagem != "") {
                                                    ...
                                                    <div class="pull-left">
                                                        <div class="font-size-20 margin-bottom-15"><?php echo $nome; ?> </div>
                                            ...
                                            <div class="panel panel-bordered">
                                                <form name="laudos" method="post" class="form-inline">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            <div class="checkbox-custom checkbox-primary col-md-2"><input type="checkbox" name="imagemtodos" id="idAll" value="todos"><label>Marcar Todos</label></div>
                                                            <div class="col-md-8">
                                                                <label>Formato</label>
                                                                <select name="tipo_laudo" class="form-control" id="tipo_laudo">
                                                            ...
                                                            <div>
                                                                ...
                                                                <input type="hidden" name="study" id="study" value="<?php echo $study; ?>">
                                                                <?php
                                                                if ($enviado != "S" && $study != "") {
                                                            ...
                                                            <div class="panel-footer">
                                                                <div align="center">
                                                                    <button type="submit" name='gravar' value='Imprimir' class="btn btn-success">Imprimir</button>
                                                                    <button type="submit" name='xcancela' value='xcancelar' class="btn btn-danger">Cancelar</button>
                                                                </div>
                                                            </div>
                                                        </div>

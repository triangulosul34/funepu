...
<head>
    ...
    <title>FUNEPU | Relatorio de Produção Medica</title>
...
<body class="pace-done" cz-shortcut-listen="true">
                                    ...
                                    <div class="col-6">
                                        <div class="float-right">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="active">Relatorio Producao Medico</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $("#imprimirelatorio").click(function(event) {
            ...
            var url = 'relproducaomed.php?start=' + start + '&end=' + end + '&profissional=' + profissional;
            window.open(url);
        });
    </script>
</body>

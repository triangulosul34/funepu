...
<div class="row">
    <div class="col-md-8">
        <h1 style="font-size: 100%; padding:0;margin:0; margin-bottom: 10px;">
            Nome: <span style="font-weight: bold;"><?php echo $rowNome->nome; ?></span>
        </h1>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <select class="form-control" style='font-size:small;' name="situacaoMod" id="situacaoMod">
            <option value=""><?php echo utf8_encode("Selecione a Situacao"); ?></option>
            <?php
    ...
    <input type="hidden" name="transacaoMod" id="transacaoMod" value="<?php echo $_GET['transacao']; ?>">
</div>
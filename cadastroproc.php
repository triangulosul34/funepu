...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($titulo == "") {
        $erro = "Título no Laudo - Campo Obrigatorio";
    }
    ...
    if ($erro == "") {
        ...
        include('conexao.php');
        $stmt = "insert into procedimentos (descricao, modalidade_id, sigtap, necessita_autorizacao, formulario, valor, laudo_padrao, dias_execucao, preparo, titulo_laudo, situacao, qtde_mes, cod_os) values ('$descricao', '$modalidade', '$codSigtap', '$autorizacao', '$formulario', $valor,  '$laudo', '$tempo', '$preparo', '$titulo', '0', $qtde_mes, '$cod_os' )";

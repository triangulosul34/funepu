...
if ($_SERVER ['REQUEST_METHOD'] == 'GET') {
	...
	if ($transacao != "") {
		include ('conexao.php');
		$stmt = "select a.transacao, a.paciente_id, a.status, a.tipo, a.dat_cad as cadastro, c.nome, c.dt_nasc, c.sexo, c.telefone, c.celular, c.endereco,
		a.oque_faz, a.com_oqfaz, a.tempo_faz, a.como_faz, c.nome_mae, c.numero, c.complemento, c.bairro, c.cep, c.num_carteira_convenio as cns, c.cidade, c.estado, a.observacao, k.origem from atendimentos a 
	...
	{	
		if ($erro == "") 
		{
			...
			if ($transacao == "") 
			{
				...
				oque_faz, tempo_faz, com_oqfaz, como_faz,acompanhante)
				values ($transacao, '$usuario_transacao', '$dt_transacao', $prontuario, '$origem', 'Atendimento Finalizado',  '1',  '$horacad', '01',"; 
				$stmt = $stmt . "  '$deficiencia', '$idade', '$observacao', '$oque_faz', '$tempo_faz', '$com_oqfaz', '$como_faz','$nome_acompanhante');";
				$sth = pg_query ( $stmt ) or die ( $stmt );
				...
				$stmtLogs = "insert into logs (usuario,tipo_acao,atendimento_id,data,hora) 
						values ('$usuario','CADASTROU UM NOVO ATENDIMENTO','$transacao','$data','$hora')";		
...
function validar() {
	...
	var nomeMae       = pedido.nomeMae.value;	
...
function showpagtos()
{
	...
	d4 = 'S';
	abre = 'N';
	if (document.getElementById("dvd").checked) { dvd  = 'S';} else {dvd = 'N';}
	if (document.getElementById("d4").checked) { d4  = 'S';} else {d4 = 'N';}
				...
				<form method="post" name='pedido' id='pedido' autocomplete="off">
					...
					<div class="panel-body">
						<div class="col-sm-12">
							...
							<div class="col-sm-3">
								<label class="control-label">Data</label> <input type="text"
									name="data_transacao" class="form-control"
									value="<?php echo inverteData($data_transacao);?>" maxlength="10" OnKeyPress="formatar('##/##/####', this)">
							</div>
							<div class="col-sm-3">
								<label class="control-label">Hora</label> <input type="text"
									name="hora_transacao" class="form-control"
									value="<?php echo $hora_transacao;?>" maxlength="5" OnKeyPress="formatar('##:##', this)">
							</div>

							<div class="col-sm-3">
								<label class="control-label">Usuario</label> <input type="text"
									name="usuario_transacao" class="form-control"
						...
						<div class="col-lg-2">
							<div>
								<?php  
									if ($imagem=="") 
									{  
									   echo "<img id=\"blah\" src=\"app-assets/img/gallery/user-transp.png\" alt=\"\" height=\"120\" width=\"130\" ondblclick=\" window.open('popcam/index.html', 'Janela', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=700, height=700'); return false;\">";
									}
									else
									{  
									   echo "<img id=\"blah\" src=\"app-assets/img/gallery/user-transp.png\ alt=\"\" height=\"120\" width=\"130\" ondblclick=\" window.open('popcam/index.html', 'Janela', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=700, height=700'); return false;\">";
						...
						<div class="col-sm-1">
							<label class="control-label"><font color='red'>Paciente</font></label>
						...
						<div id="dados-paciente-div">
							<input type="hidden" class="form-control" name="prontuario" id="prontuario" placeholder="Paciente..."
								value='<?php echo $prontuario;?>' readonly>
							<input type="hidden" class="form-control" name="imagem" id="imagem" value="<?php echo $imagem;?>"
								value='<?php echo $imagem;?>' readonly>
							<div class="col-sm-9">
								<label class="control-label">Nome </label> <input type="text"
									name="nome" id="nome" class="form-control"
									style="font-weight: bold;" value="<?php echo $nome;?>"
									onkeyup="maiuscula(this)">
							</div>
							<div class="col-sm-5">
								<label class="control-label">Nome Social</label> <input type="text"
									name="nome_social" id="nome_social" class="form-control" value="<?php echo $nome_social;?>"
									style="font-weight: bold;"
									onkeyup="maiuscula(this)">
							</div>
							<div class="col-sm-5">
								<label class="control-label">Nome do Acompanhante</label> <input type="text"
									name="nome_acompanhante" id="nome_acompanhante" class="form-control" value="<?php echo $nome_acompanhante;?>"
									style="font-weight: bold;"
									onkeyup="maiuscula(this)">
							</div>
							<div class="col-sm-3">
								<label class="control-label"><font color='red'>CNS</font></label> <input type="text"
									name="cns" id="cns" class="form-control"
									value="<?php echo $cns;?>"
							...
							<div class="col-sm-3">
								<label class="control-label">Nascimento</label> <input
									...
									class="form-control" value="<?php echo $dt_nascimento;?>"
									OnKeyPress="formatar('##/##/####', this)"
									OnBlur="calcularIdade(this.value)">
							</div>
							
							<div class="col-sm-3">
								<label class="control-label">Idade</label><input type="text"
									name="idade" id="idade" class="form-control"
									value="<?php echo $idade;?>" readonly>
							</div>
							...
							<div class="col-sm-3">
								...
								<select name="sexo" id="sexo" class="form-control">
									...
									name="pendencia" id="pendencia" class="form-control"
									value="<?php echo $pendencia;?>" readonly>
							</div>
							
							<div class="col-sm-3">
							<label class="control-label">CPF</label> <input
								type="text" name="cpf" OnKeyPress="formatar('###.###.###-##', this)" maxlength="14" id="cpf"
								class="form-control" value="<?php echo $cpf;?>">
						</div>
						
						<div class="col-sm-3">
							<label class="control-label">RG</label> <input
								type="text" name="rg" id="rg"
								class="form-control" value="<?php echo $identidade;?>">
						</div>
						<div class="col-sm-3">
							<label class="control-label">Órgão Expedidor</label> <input type="text"
								name="org_expeditor" id="org_expeditor" onkeyup="maiuscula(this)" class="form-control"
							...
							<div class="col-sm-3">
								<label class="control-label">CEP</label> <input type="text"
									...
									value="<?php echo $cep;?>"
									OnKeyPress="formatar('#####-###', this)" onblur="pesquisacep(this.value);">
							</div>
							...
							<div class="col-sm-2">
								<label class="control-label">Complemento</label> <input
									type="text" name="end_comp" id="end_comp" class="form-control"
							...
							<div class="col-sm-2">
								...
								<input type="text" name="end_uf" id="end_uf" class="form-control"
									value="<?php echo $estado;?>" maxlength="2" onkeyup="maiuscula(this)">
							</div>

							<div class="col-sm-3">
								<label class="control-label"><font color='red'>Telefone</font></label> <input type="text"
							...
							<div class="col-sm-6">
								<label class="control-label"><font color='red'>Nome da Mae</font></label> <input type="text"
									name="nomeMae" class="form-control" value="<?php echo $nomeMae;?>" onkeyup="maiuscula(this)">
							</div>
						...
						<div class="col-sm-6">
							<label class="control-label"><font color='red'>Origem</font></label> 
							<select
								class="form-control" name="origem" id="origem"
						...
						<hr style="width: 100%; color: #76838; height: 1px; background-color: #76838;" />

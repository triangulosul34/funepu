...
include('conexao.php');
$sql = "insert into controle_antimicrobiano(ordem, medicamento, via, aprazamento, categoria, quantidade) values($ordem, '$antibiotico', '$via', '$aprazamento', $categoria, $quantidade)";

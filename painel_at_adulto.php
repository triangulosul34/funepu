...
<head>
    ...
    <title>FUNEPU | Atendimento Adulto</title>
    ...
    <div class="main-panel">
                                    ...
                                    <div class="col-6">
                                        <div class="float-right">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="active">Atendimento Adulto</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                        ...
                                        <div class="col-12">
                                            <table class="table" id="dados">
                                                ...
                                                <tbody>
                                                    ...
                                                    include('conexao.php');
                                                    $stmt = "select a.transacao, a.transacao, a.paciente_id, a.status, a.prioridade, a.hora_cad,a.hora_triagem,a.hora_atendimento, a.dat_cad as cadastro, 	c.nome, k.origem, f.descricao as clinica,a.hora_destino, 
									...
									left join tipo_origem k on k.tipo_id=cast(a.tipo as integer) ";
                                                    ...
                                                    $stmt = $stmt . " AND a.especialidade = 'Consultorio Adulto' order by 5 ";
                                                    $sth = pg_query($stmt) or die($stmt);
                                                    //echo $stmt; 
                                                    $x = 0;
                                                    while ($row = pg_fetch_object($sth)) {
                                                        $x = $x + 1;
                                                        /*if ($row->prioridade   =='AMARELO')  {$classe="style=\"background-color:gold\"";}
										if ($row->prioridade   =='VERMELHO') {$classe="class='bg-danger'";}
										if ($row->prioridade   =='VERDE')   {$classe="class='bg-success'";}
										if ($row->prioridade   =='AZUL')    {$classe="class='bg-primary'";}
										if ($row->prioridade   =='LARANJA') {$classe="class='bg-warning'";}	
										if ($row->prioridade   =='') {$classe="style=\"background-color:Gainsboro\"";}	
										*/
                                                        ...
                                                        <input type=\"checkbox\" class=\"custom-control-input\" id=\"" . $row->transacao . "\" name=\"cb_exame[]\" value=\"" . $row->exame_nro . "\">
                                                        <label class=\"custom-control-label\" for=\"" . $row->transacao . "\"></label></div></td>";
                                                        ...
                                                        //echo "<a href=\"atendimentoclinico.php?id=$row->transacao\"  target=\"_blank\" type=\"button\" class=\"btn btn-sm btn-icon btn-pure btn-default delete-row-btn\" data-toggle=\"tooltip\" data-original-title=\"Visualizar\"><i class=\"icon wb-search\" aria-hidden=\"true\"></i></a>";
                                                        /*}*/
        ...
        <script>
            function atualizar() {
                ...
                var url = 'atualizaatendimentos_adulto.php?start=' + start + '&end=' + end + '&modalidade=' + modalidade + '&situacao=' + situacao + '&nome=' + nome;

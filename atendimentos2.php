                                                    ...
                                                    <tbody>
                                                        ...
                                                        while ($row = pg_fetch_object($sth)) {
                                                            ...
                                                            if ($row->coronavirus == 1) {
                                                                ...
                                                                echo "<td class='blink'>" . inverteData(substr($row->cadastro, 0, 10)) . '<br>' . $row->hora_cad . "</td>";
                                                                ...
                                                                echo "<td style='display:none;'><div class=\"checkbox-custom checkbox-primary\"><input type=\"checkbox\" class='marcar' name=\"cb_exame[]\"    value=\"" . $row->exame_nro . "\"><label></label></div></td>";
                                                                echo "<td>" . inverteData(substr($row->cadastro, 0, 10)) . '<br>' . $row->hora_cad . "</td>";
                                                                echo "<td ><a data-toggle=\"popover\" data-content=\"Ir para o cadastro do paciente.\" data-trigger=\"hover\" data-original-title=\"Paciente\" href='novoatendimento.php?id=" . $row->transacao . "' target='_blank'>" . $row->nome . '<br><br> Origem:' . $row->origem . "</a></td>";
                                                                //echo "<td>".utf8_encode($row->convenio)."</td>";							
                                                            ...
                                                            echo "<a href=\"atendimentoclinico.php?id=$row->transacao\" target=\"_blank\" class=\"btn btn-sm btn-icon btn-pure btn-default delete-row-btn\" data-toggle=\"tooltip\" data-original-title=\"Visualizar\"><i class=\"fas fa-file-medical\"></i></a>";
                                                            /*}*/


                                                            if ($row->tipo == 9) {
                                                                echo "<a href=\"relOdonto.php?id=$row->transacao\" target=\"_blank\" class=\"btn btn-sm btn-icon btn-pure btn-default delete-row-btn\" data-toggle=\"tooltip\" data-original-title=\"ODONTOLOGICO\"><i class=\"fas fa-print\"></i></a>";
                                                            } else {

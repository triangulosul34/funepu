...
$sql = "select count(*), exame_id from pedido_item where " . ORIGEM_CONFIG  . str_pad($atendimento, 7, '0', STR_PAD_LEFT) . " = substring(ordem_servico, 5,9)::integer and exame_id in ($procedi) group by 2 order by count desc";

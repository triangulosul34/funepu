...
<nav class="navbar navbar-expand-lg navbar-light bg-faded header-navbar" style="padding-top: 0px;">
    <div class="container-fluid" style="height: 75px;">
        ...
        <div onclick="javascript:location.href='http://<?php echo URL_BASE; ?>/index.php'"
            class="navbar-header teste"
            style="background-color: #12A1A6; border-top-right-radius: 30px;border-bottom-right-radius:30px">
            <h5 style="margin: 0; padding: 0"><strong>UNIDADE <?php echo $unid_desc; ?></strong></h5>
        </div>

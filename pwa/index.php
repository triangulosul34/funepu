...
FROM atendimentos 
where  extract(month from dat_cad)='" . date('m') . "' and extract(year from dat_cad)='" . date('Y') . "' 
and hora_destino is not null and (hora_destino > hora_cad and dat_cad = data_destino)";
$sth = pg_query($stmt);
$tempo_medio_mes = pg_fetch_object($sth);
            ...
            <div class="main-content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-12 mt-3 mb-1">
                                    ...
                                    <p class="content-sub-header">Dados de <?php echo date('d/m/Y'); ?></p>
                                </div>
                            </div>
                                            ...
                                            <div class="px-3 py-3" >
                                                <div class="media">
                                                    <div class="media-body white text-left">
                                                        ...
                                                        if ($unidade=='2') { include('conexaosb.php'); } else { include('conexao.php'); }
                                                        $stmt = "Select count(*) as qtde from atendimentos where dat_cad='" . date('Y-m-d') . "' ";
                                                        $sth = pg_query($stmt) or die($stmt);
                                                        $row = pg_fetch_object($sth);
                                            ...
                                            <div class="px-3 py-3" >
                                                <div class="media">
                                                    <div class="media-body white text-left">
                                                        ...
                                                        if ($unidade=='2') { include('conexaosb.php'); } else { include('conexao.php'); }
                                                        $stmt = "Select count(*) as qtde from atendimentos where dat_cad='" . date('Y-m-d') . "' and  status='Atendimento Finalizado'";
                                                        $sth = pg_query($stmt) or die($stmt);
                                                        $row = pg_fetch_object($sth);
                                            ...
                                            <div class="px-3 py-3">
                                                <div class=" media">
                                                    ...
                                                    <?php
                                                        ...
                                                        if ($unidade=='2') { include('conexaosb.php'); } else { include('conexao.php'); }
                                                        $stmt = "Select count(*) as qtde from atendimentos where dat_cad='" . date('Y-m-d') . "' and status = 'Aguardando Triagem' ";
                                                        $sth = pg_query($stmt) or die($stmt);
                                                        $row = pg_fetch_object($sth);
                                            ...
                                            <div class="px-3 py-3" >
                                                <div class="media">
                                                    ...
                                                    <?php
                                                        ...
                                                        if ($unidade=='2') { include('conexaosb.php'); } else { include('conexao.php'); }
                                                        $stmt = "Select count(*) as qtde from atendimentos where dat_cad='" . date('Y-m-d') . "' and status = 'Aguardando Atendimento' ";
                                                        $sth = pg_query($stmt) or die($stmt);
                                                        $row = pg_fetch_object($sth);
                                                    ...
                                                    <div class="media-body white text-right">
                                                        <div class="media-body white text-right">
                                                            <?php
                                                                ...
                                                                if ($unidade=='2') { include('conexaosb.php'); } else { include('conexao.php'); }
                                                                $stmt = "Select count(*) as qtde from atendimentos where dat_cad='" . date('Y-m-d') . "' and status = '".'Em Triagem'."'";
                                                                $sth = pg_query($stmt) or die($stmt);
                                                                $row = pg_fetch_object($sth);

                                                                echo '<h3>' . str_pad($row->qtde, 3, '0', STR_PAD_LEFT) . '</h3>';
                                                            ?>
                                                            <span>MONITOR EM TRIAGEM</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="media-body white text-right">
                                                        <div class="media-body white text-right">
                                                            <?php
                                                                ...
                                                                if ($unidade=='2') { include('conexaosb.php'); } else { include('conexao.php'); }
                                                                $stmt = "Select count(*) as qtde from atendimentos where dat_cad='" . date('Y-m-d') . "' and status = 'Em Atendimento' ";
                                                                $sth = pg_query($stmt) or die($stmt);
                                                                $row = pg_fetch_object($sth);
                                                    ...
                                                    <div class="media-body white text-right">
                                                        <div class="media-body white text-right">
                                                            <?php
                                                                ...
                                                                if ($unidade=='2') { include('conexaosb.php'); } else { include('conexao.php'); }
                                                                $stmt = "Select count(*) as qtde from atendimentos where dat_cad='" . date('Y-m-d') . "' and status like 'N%' ";
                                                                $sth = pg_query($stmt) or die($stmt);
                                                                $row = pg_fetch_object($sth);

                                                                echo '<h3>' . str_pad($row->qtde, 3, '0', STR_PAD_LEFT) . '</h3>';
                                                            ?>
                                                            <span>NÃO RESPONDEU CHAMADO</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-content">
                                            <div class="px-3 py-3" >
                                                <div class=" media">
                                                    ...
                                                    <div class="media-body white text-right">
                                                        <p>Tempo médio de espera no Mês</p>
                                                        <p><?php echo date('m/Y'); ?></p>
                                                        <h1><?php echo substr($tempo_medio_mes->media_tempo, 0, 5); ?></h1>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <p>Acumulado <?php echo date('d/m/Y'); ?></p>
                ...
                <script>
                    ...
                    var mensal_idade = new Chart(ctx, {
                        type: 'bar',
                        data: {
                            labels: ['<?php echo $mensal_idade[0]['faixaetaria']; ?>', '<?php echo $mensal_idade[1]['faixaetaria']; ?>', '<?php echo $mensal_idade[2]['faixaetaria']; ?>', '<?php echo $mensal_idade[3]['faixaetaria']; ?>', '<?php echo $mensal_idade[4]['faixaetaria']; ?>'],
                            datasets: [{
                                data: ['<?php echo $mensal_idade[0]['valor']; ?>', '<?php echo $mensal_idade[1]['valor']; ?>', '<?php echo $mensal_idade[2]['valor']; ?>', '<?php echo $mensal_idade[3]['valor']; ?>', '<?php echo $mensal_idade[4]['valor']; ?>'],
                                backgroundColor: [
                                    'rgba(131,111,255, 1)',
                                    'rgba(0,0,255, 1)',
                                    'rgba(0,128,0, 1)',

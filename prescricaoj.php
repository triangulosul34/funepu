...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if ($pr != "") {
        ...
        while ($rowu = pg_fetch_object($stu)) {
            $si = "insert into prescricao_item (prescricao_id, descricao, dosagem, aprazamento, codigo_medicamento, via, complemento, prescricao_item_id, tipo, diluente, bomba)
						values($prescricao, '$rowu->descricao', ";
            if ($rowu->dosagem == '') {
                $si = $si . "null,";
            } else {
                $si = $si . "'$rowu->dosagem',";

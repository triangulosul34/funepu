                                    ...
                                    <div class="col-6">
                                        <div class="float-right">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="active">Atendimento Retroativo</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <form method="post" name='pedido' id='pedido' autocomplete="off" action="#">
                                        <div id="dados-paciente-div">
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="col-10">
                                                    <div class="row"><input type="hidden" name="transacao" class="form-control" value="<?php echo $transacao; ?>" readonly>
                                                        <div class="col-sm-6">
                                                            <label class="control-label">Data </label>
                                                            <input type="text" name="data_transacao" class="form-control" value="<?php echo inverteData($data_transacao); ?>" onkeypress="formata(this,'##/##/####')">
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <label class="control-label">Hora </label>
                                                            <input type="text" name="hora_transacao" class="form-control" value="<?php echo $hora_transacao; ?>" onKeyPress="formata(this,'##:##')">
                                                        </div>
                                                        <input type="hidden" name="senhac" class="form-control" value="<?php echo senhal; ?>" readonly><input type="hidden" name="usuario_transacao" class="form-control" value="<?php echo $usuario; ?>" readonly><input type="hidden" name="situacao" class="form-control" value="<?php echo $situacao; ?>" readonly>

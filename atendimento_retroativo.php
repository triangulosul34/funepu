                                        ...
                                        <div id="dados-paciente-div">
                                                ...
                                                <div class="col-10">
                                                    <div class="row"><input type="hidden" name="transacao"
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <input type="text" name="data_transacao"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <input type="text" name="hora_transacao"
                                                                class="form-control"
                                                                value="<?php echo $hora_transacao; ?>"
                                                                onKeyPress="formata(this,'##:##')">
                                                        </div>
                                                        <input type="hidden" name="senhac" class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    </label> <input type="text" name="nomeMae" class="form-control"

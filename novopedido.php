			...
			<div class="main-content">
		        ...
		        <div class="col-sm-12">
								<strong>Erro:!</strong><br><li>' . $erro . '</li>
										...
										<form method="post" name='pedido' id='pedido' autocomplete="off" action="#">
											<div id="dados-paciente-div">
												<div class="col-12 text-center">
													<h4 class="form-section-center"><i class="ft-user"></i>
														Identificação do Paciente</h4>
												...
												<div class="row mt-4">
													...
													<div class="col-10">
														...
														<div class="row">
															...
															<div class="col-sm-3">
																<label class="control-label">Sexo</label> <input
																	type="text" name="sexo" id="sexo"
																	class="form-control"
																	value="<?php echo $sexo; ?>"
																	onkeyup="maiuscula(this)"> <input type="hidden"
												...
												<div class="row">
													<div class="col-sm-2">
														<label class="control-label">CEP</label> <input type="text"
															name="end_cep" id="end_cep" class="form-control"
															maxlength="9"
															value="<?php echo $cep; ?>"
															OnKeyPress="formatar('#####-###', this)"
													...
													<div class="col-sm-4">
														<label class="control-label">Complemento</label> <input
															type="text" name="end_comp" id="end_comp"
															class="form-control"
												...
												<div class="row">
													...
													<div class="col-sm-2">
														...
														<input type="text" name="end_uf" id="end_uf"
															class="form-control"
												...
												<div class="row">
													...
													<div class="col-4">
														...
														</label> <select class="form-control" name="origem" id="origem"
													...
													<div class="col-2">
														<label class="control-label">Enfermaria</label> <input
															type="text" name="enfermaria" id="enfermaria"
															class="form-control"
															value="<?php echo $enfermaria; ?>"
															maxlength='3'>
													</div>
													<div class="col-2">
														<label class="control-label">Leito</label> <input type="text"
															name="leito" id="leito" class="form-control" maxlength='4'
															value="<?php echo $leito; ?>"><br>
													</div>
												</div>
												<div class="row">
													<div class="col-2">
														<label class="control-label">Data Solicit.</label> <input
															type="text" name="dt_nsolicitacao" class="form-control"
															value="<?php if ($dt_nsolicitacao != '') {
													...
													<div class="col-2">
														...
														<div class="row">
															...
															<div class="col-4">
																<button type="button" class="btn btn-primary"
																	onClick="window.open('popsol.php', 'Janela', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=700, height=500'); return false;">
													...
													<div class="col-4">
														<label class="control-label">Nome Solicitante</label> <input
															type="text" name="nomesolicitante" class="form-control"
															value="<?php echo $nomesolicitante; ?>"
															OnKeyPress="formatar('##-#########', this)">
													</div>
													<div class="col-2">
														<label class="control-label">Telef.Solicitante</label> <input
															type="text" name="telsolicitante" class="form-control"
															value="<?php echo $telsolicitante; ?>"
															OnKeyPress="formatar('##-#########', this)" maxlength="11">
													</div>
													<div class="col-2">
														<label class="control-label">Celular Solic.</label> <input
															type="text" name="celsolicitante" class="form-control"
															value="<?php echo $celsolicitante; ?>"
															OnKeyPress="formatar('##-#########', this)" maxlength="12">
													</div>
												</div>
												<div class="row mt-3">
													<div class="col-12 text-center">
														<h4 class="form-section-center">
															Exames Solicitados</h4>
														<!-- <h3 class="title" align="center">Identificação do Paciente</h3> -->
									...
									include 'conexao.php';
									/*$conv = substr ( $convenio, 1, strlen ( $convenio ) - 1 );
										$sql = "select tabela_id from convenios where convenio_id=$conv";
										$res = pg_query($sql) or die($sql);
										$row = pg_fetch_object($res);
										$tabela = $row->tabela_id;
										   */
									$sql = 'select procedimento_id, a.descricao, a.sigtap from procedimentos a order by a.descricao';
									$sth = pg_query($sql) or die($sql);
									echo '<option value="">Selecione o Procedimento</option>';
									while ($row = pg_fetch_object($sth)) {
										echo '<option value="' . $row->procedimento_id . '"';
										if ($row->procedimento_id == $procedimento) {
											echo 'selected';
											$codigo = $row->codigo;
											$qtde = '01';
										}
										echo '>' . $row->codigo . '-' . $row->descricao . '</option>';
									}
									...
									?>
													...
													<div class="col-md-1">
														<label class="control-label">
															<font color='red'>Qtde</font>
														</label>
														<input type="text" name="qtde" id="qtde" class="form-control"
															maxlength="2"
															value="<?php echo str_pad($qtde, '2', '0', STR_PAD_LEFT); ?>">
														</br>
													</div>
													<div class="col-md-1">
												...
												<table
													...
													<thead>
														<tr>
															...
															<th width='5%'>Qtde</th>
															<th width='10%'>Servicos</th>
															<th width='10%'>Adicionais</th>
															<th width='17%'>Autorizacao</th>
											...
											$x = 0;
											include 'conexao.php';
											$stmt = 'SELECT a.exame_nro, a.exame_id, a.dvd, a.d4, a.transacao, a.qtde, a.guia, b.descricao, a.valor 
															 FROM itenspedidos a left join pedidos c on a.transacao=c.transacao left join procedimentos b on
															 a.exame_id=b.procedimento_id left join  convenios d on c.convenio_id=d.convenio_id
															 where ';
											if ($transacao != '') {
												$stmt = $stmt . " a.transacao=$transacao ";
											} else {
												$stmt = $stmt . ' a.transacao is null ';
											}
											$stmt = $stmt . ' order by exame_nro';
											$sth = pg_query($stmt) or die($stmt);
											while ($row = pg_fetch_object($sth)) {
												$x = $x + 1;
												echo '<tr>';
												echo '<td>' . $row->descricao . '</td>';
												echo '<td>' . str_pad($row->qtde, '3', '0', STR_PAD_LEFT) . '</td>';
												echo '<td></td>';
												echo '<td></td>';
												echo '<td>' . $row->guia . '</td>';
												...
												<div class="col-md-12" align="center">
													<div class="form-group">
														<input type='submit' name='gravar' class="btn btn-primary"
															value='Gravar' onclick="return validar()">
